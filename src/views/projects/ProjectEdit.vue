...
const loadProject = async () => {
  ...
  const result = await projectsStore.fetchProjectById(projectId)
...
const handleSubmit = async () => {
  const result = await projectsStore.updateProject(projectId, formData.value)
      ...
      <div class="grid gap-6">
        ...
        <Card>
          ...
          <CardContent class="grid gap-4">
            ...
            <div class="grid gap-4 md:grid-cols-3">
              ...
              <div class="grid gap-2">
                <Label for="spent">Spent (PHP)</Label>
                <Input
                  id="spent"
        ...
        <div class="flex gap-2 justify-end">
          ...
          <Button type="submit" :disabled="projectsStore.isLoading">
            {{ projectsStore.isLoading ? 'Saving...' : 'Save Changes' }}
          </Button>
        </div>
      </div>
    </form>
